...
const TEMPLATES = [
    // ATHLETE ARCHETYPE
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'exercise', days: 30 },
        priority: 1,
        used: false
    },
    {
        ...
        sponsorName: 'Fitbit',
        requirements: { type: 'steps', count: 10000, days: 7 },
        priority: 2,
        used: false
    },
    {
        ...
        sponsorName: 'Wim Hof',
        requirements: { type: 'habit_completion', habitType: 'cold_exposure', days: 21 },
        priority: 3,
        used: false
    },
    {
        ...
        sponsorName: 'Aaptiv',
        requirements: { type: 'habit_completion', habitType: 'exercise', days: 21 },
        priority: 4,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'mobility', days: 7 },
        priority: 5,
        used: false
    },
    ...
    // STOIC ARCHETYPE
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'meditation', days: 30 },
        priority: 6,
        used: false
    },
    {
        ...
        sponsorName: 'Day One',
        requirements: { type: 'habit_completion', habitType: 'journaling', days: 21 },
        priority: 7,
        used: false
    },
    {
        ...
        sponsorName: 'Opal',
        requirements: { type: 'screen_time', limit: 120, days: 2 },
        priority: 8,
        used: false
    },
    {
        ...
        sponsorName: 'Stoic',
        requirements: { type: 'habit_completion', habitType: 'gratitude', days: 14 },
        priority: 9,
        used: false
    },
    {
        ...
        affiliateLink: 'https://wimhofmethod.com?ref=emerge',
        sponsorName: 'Wim Hof',
        requirements: { type: 'habit_completion', habitType: 'cold', days: 7 },
        priority: 10,
        used: false
    },
    ...
    // SCHOLAR ARCHETYPE
    {
        ...
        sponsorName: 'Kindle',
        requirements: { type: 'habit_completion', habitType: 'reading', count: 7 },
        priority: 11,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'reading', pages: 100 },
        priority: 12,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'learning', days: 14 },
        priority: 13,
        used: false
    },
    {
        ...
        sponsorName: 'Ulysses',
        requirements: { type: 'habit_completion', habitType: 'writing', words: 30000 },
        priority: 14,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'focus', sessions: 3 },
        priority: 15,
        used: false
    },
    ...
    // CREATOR ARCHETYPE
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'creation', days: 30 },
        priority: 16,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'practice', days: 21 },
        priority: 17,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'coding', days: 100 },
        priority: 18,
        used: false
    },
    {
        ...
        sponsorName: 'Adobe',
        requirements: { type: 'habit_completion', habitType: 'photography', days: 30 },
        priority: 19,
        used: false
    },
    {
        ...
        requirements: { type: 'habit_completion', habitType: 'ship', count: 1 },
        priority: 20,
        used: false
    },
];

export const seedChallengeTemplates = functions.https.onRequest(async (req, res) => {
    const db = getDb();
