...
final tribeBlueprintsProvider = StreamProvider.autoDispose
    .family<List<Blueprint>, String>((ref, tribeArchetypeId) {
...
final tribeCreatorBlueprintsProvider = StreamProvider.autoDispose
    .family<List<Blueprint>, String>((ref, tribeId) {
      final repository = ref.watch(blueprintRepositoryProvider);
      return repository.getBlueprints().map((blueprints) {
