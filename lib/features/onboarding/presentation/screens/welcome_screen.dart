    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          SafeArea(
            // LayoutBuilder + scroll view: keep the vertical Spacer layout on
            // tall screens, but scroll instead of overflowing when the
            // viewport is short (e.g. the IDX web preview pane).
            child: LayoutBuilder(
