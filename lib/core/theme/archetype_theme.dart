...
class ArchetypeTheme {
  ...
  static final _athleteTheme = ArchetypeTheme(
    ...
    suggestedHabits: [
      ArchetypeHabitSuggestion(
        title: 'Zone 2 Cardio',
        description: '45 mins steady-state',
        anchor: 'Morning',
        icon: Icons.favorite,
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Drink 1 gallon',
        anchor: 'Throughout day',
      ...
      ArchetypeHabitSuggestion(
        title: 'Breathwork',
        description: 'Box breathing (5 mins)',
        anchor: 'Pre-sleep',
        icon: Icons.air,
      ...
      ArchetypeHabitSuggestion(
        ...
        description: '10 min morning sun',
        anchor: 'Wake up',
        icon: Icons.wb_sunny,
      ...
      ArchetypeHabitSuggestion(
        title: 'Stretching',
        description: '10 min static stretch',
        anchor: 'Post-workout',
        icon: Icons.boy,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ...
      ArchetypeHabitSuggestion(
        title: 'Vitals Log',
        description: 'Record resting HR/HRV',
        anchor: 'Wake up',
  ...
  static final _scholarTheme = ArchetypeTheme(
    ...
    suggestedHabits: [
      ...
      ArchetypeHabitSuggestion(
        ...
        description: '90 mins undistracted',
        anchor: 'Morning',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Publish one small thing',
        anchor: 'End of day',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'One sketch or photo',
        anchor: 'Evening',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Learn one shortcut',
      ...
      ArchetypeHabitSuggestion(
        title: 'Analog Hour',
        description: 'No digital devices',
        anchor: 'After dinner',
      ...
      ArchetypeHabitSuggestion(
        title: 'Swipe File',
        description: 'Save 1 piece of inspiration',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: '30 mins rough draft',
        anchor: 'Morning',
        icon: Icons.drafts,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        title: 'Refining Phase',
        description: '30 mins editing',
        anchor: 'Afternoon',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Read outside your field',
        anchor: 'Evening',
        icon: Icons.explore,
        timeOfDayPreference: TimeOfDayPreference.evening,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: 'Share work-in-progress',
        anchor: 'Weekly',
        icon: Icons.forum,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: '15 mins deliberate practice',
        anchor: 'Daily',
        icon: Icons.handyman,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Just write, no edits',
        anchor: 'Morning',
        icon: Icons.create,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
  ...
  static final _creatorTheme = ArchetypeTheme(
    ...
    suggestedHabits: [
      ArchetypeHabitSuggestion(
        ...
        description: 'Read 2 sources on 1 topic',
        anchor: 'Evening',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Read original text',
        anchor: 'Deep work',
      ...
      ArchetypeHabitSuggestion(
        title: 'Mental Models',
        description: 'Apply 1 model to life',
        anchor: 'Journaling',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: '15 mins Duo/Babbel',
        anchor: 'Lunchtime',
        icon: Icons.language,
        timeOfDayPreference: TimeOfDayPreference.afternoon,
      ),
      ...
      ArchetypeHabitSuggestion(
        ...
        description: '30 mins random Wikipedia',
        anchor: 'Weekend',
        icon: Icons.search,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Solve 1 logic puzzle',
        anchor: 'Morning',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Write 200 words formal',
        anchor: 'Deep work',
      ...
      ArchetypeHabitSuggestion(
        title: 'Thesis Review',
        description: 'Review core arguments',
        anchor: 'Weekly',
  ...
  static final _stoicTheme = ArchetypeTheme(
    ...
    suggestedHabits: [
      ArchetypeHabitSuggestion(
        ...
        description: 'Negative visualization',
        anchor: 'Morning',
        icon: Icons.cloud_off,
        defaultTime: const TimeOfDay(hour: 6, minute: 30),
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        title: 'Dichotomy of Control',
        description: 'List what you control',
        anchor: 'When stressed',
        icon: Icons.alt_route,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        title: 'Amor Fati',
        description: 'Embrace an obstacle',
        anchor: 'Daily review',
        icon: Icons.favorite_border,
        timeOfDayPreference: TimeOfDayPreference.evening,
      ),
      ArchetypeHabitSuggestion(
        title: 'Voluntary Hardship',
        description: 'Sleep on floor / fast',
        anchor: 'Weekly',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Review moral choices',
        anchor: 'Bedtime',
        icon: Icons.balance,
        defaultTime: const TimeOfDay(hour: 21, minute: 0),
        timeOfDayPreference: TimeOfDayPreference.evening,
      ...
      ArchetypeHabitSuggestion(
        title: 'Memento Mori',
        description: 'Meditate on mortality',
        anchor: 'Morning',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Strip emotional language',
        anchor: 'Journaling',
      ...
      ArchetypeHabitSuggestion(
        ...
        anchor: 'When overwhelmed',
        icon: Icons.public,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        title: 'Temperance Check',
        description: 'Stop eating at 80%',
        anchor: 'Meals',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Count to 5 before reacting',
        anchor: 'Arguments',
        icon: Icons.pan_tool,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        title: 'Endurance Hold',
        description: 'Plank or wall sit',
        anchor: 'Workout',
        icon: Icons.timer,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: 'Use only essentials',
        anchor: 'Monthly',
        icon: Icons.inventory_2,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        title: 'Gratitude for Basics',
        description: 'Appreciate water/shelter',
        anchor: 'Morning',
        icon: Icons.water_drop,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        title: 'Silence Fast',
        description: '1 hour no speaking',
        anchor: 'Evening',
        icon: Icons.volume_off,
        timeOfDayPreference: TimeOfDayPreference.evening,
      ),
      ArchetypeHabitSuggestion(
        title: 'Journaling (Aurelius)',
        description: 'Write only for yourself',
        anchor: 'Morning',
        icon: Icons.book,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
  ...
  static final _zealotTheme = ArchetypeTheme(
    ...
    suggestedHabits: [
      ArchetypeHabitSuggestion(
        title: 'Sacred Ritual',
        description: 'Morning devotion/prayer',
        anchor: 'Wake up',
      ...
      ArchetypeHabitSuggestion(
        title: 'Fasting Block',
        description: '16h intermittent fast',
        anchor: 'Daily',
        icon: Icons.no_food,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: 'Read vision statement',
        anchor: 'Morning',
        icon: Icons.flag,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: '2h deep work block',
        anchor: 'Morning',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: '1 act of service',
        anchor: 'Weekly',
        icon: Icons.volunteer_activism,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        title: 'Scripture/Text Study',
        description: 'Read core philosophy',
        anchor: 'Evening',
      ...
      ArchetypeHabitSuggestion(
        ...
        description: 'Message accountability partner',
        anchor: 'Weekly',
        icon: Icons.people,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        title: 'Purification',
        description: 'Sauna or sweat lodge',
        anchor: 'Weekend',
        icon: Icons.hot_tub,
        timeOfDayPreference: TimeOfDayPreference.anytime,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: '10 min vocalization',
        anchor: 'Morning',
        icon: Icons.record_voice_over,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        ...
        description: 'Declutter 1 item',
        anchor: 'Daily',
        icon: Icons.delete_outline,
        timeOfDayPreference: TimeOfDayPreference.evening,
      ),
      ArchetypeHabitSuggestion(
        title: 'Charismatic Speaking',
        description: 'Practice articulation',
        anchor: 'Before meetings',
        icon: Icons.campaign,
        timeOfDayPreference: TimeOfDayPreference.morning,
      ),
      ArchetypeHabitSuggestion(
        title: 'Zealous Defense',
        description: 'Argue for your cause',
        anchor: 'Writing',
        icon: Icons.shield,
        timeOfDayPreference: TimeOfDayPreference.afternoon,
      ),
