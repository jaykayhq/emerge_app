...
class UserStatsDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<void> upsertFromFirebase(
    String userId,
    ...
    await upsertStats(
      UserStatsTableCompanion(
        ...
        characterClass: Value(data['characterClass'] as String?),
        motive: Value(data['motive'] as String?),
        why: Value(data['why'] as String?),
        anchorsJson: Value(data['anchorsJson'] as String?),
        habitStacksJson: Value(data['habitStacksJson'] as String?),
        skippedOnboardingStepsJson: Value(
          data['skippedOnboardingStepsJson'] as String?,
        ),
        settingsJson: Value(data['settingsJson'] as String?),
        ...
        onboardingStartedAt: Value(data['onboardingStartedAt'] as String?),
        hasEmerged: Value(data['hasEmerged'] as bool? ?? false),
        momentumScore: Value(
