...
class ChallengeProgressDao extends DatabaseAccessor<AppDatabase>
    with _$ChallengeProgressDaoMixin {
  ...
  Future<void> insertFromData({
    ...
    return into(challengeProgressTable).insertOnConflictUpdate(
