...
/// Firestore-backed implementation of [FriendRepository].
///
/// Used on web platforms where Drift/SQLite is not available.
/// Operates directly on Firestore collections (`users/{uid}/friends`,
/// `partner_requests`, `invite_codes`, `users/{uid}/presence`) with
/// no local database layer.
///
/// Matches the interface of the data-layer [FirestoreFriendRepository]
/// but configured for the core firestore_repositories pattern.
class FirestoreFriendRepository implements FriendRepository {
  final FirebaseFirestore _firestore;

  FirestoreFriendRepository({required FirebaseFirestore firestore})
