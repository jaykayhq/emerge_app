        ...
        await _db
            ...
            .insert(
              UserStatsTableCompanion(
                ...
                strengthXp: Value((stats['strengthXp'] as num?)?.toInt() ?? 0),
                intellectXp: Value(
                  (stats['intellectXp'] as num?)?.toInt() ?? 0,
                ),
                vitalityXp: Value((stats['vitalityXp'] as num?)?.toInt() ?? 0),
                creativityXp: Value(
                  (stats['creativityXp'] as num?)?.toInt() ?? 0,
                ),
                focusXp: Value((stats['focusXp'] as num?)?.toInt() ?? 0),
                spiritXp: Value((stats['spiritXp'] as num?)?.toInt() ?? 0),
                challengeXp: Value(
                  (stats['challengeXp'] as num?)?.toInt() ?? 0,
                ),
                ...
                skippedOnboardingStepsJson: Value(
                  stats['skippedOnboardingStepsJson'] as String?,
                ),
                ...
                onboardingProgress: Value(
                  (stats['onboardingProgress'] as num?)?.toInt() ?? 0,
                ),
                onboardingCompletedAt: Value(
                  stats['onboardingCompletedAt'] as String?,
                ),
                onboardingStartedAt: Value(
                  stats['onboardingStartedAt'] as String?,
                ),
                hasEmerged: Value((stats['hasEmerged'] as bool?) ?? false),
                momentumScore: Value(
            ...
            .insert(
              HabitCompletionsTableCompanion(
                ...
                momentumAtCompletion: Value(
                  (data['momentumAtCompletion'] as num?)?.toInt(),
                ),
