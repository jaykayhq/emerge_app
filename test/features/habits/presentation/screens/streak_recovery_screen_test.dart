...
void main() {
  testWidgets(
    'StreakRecoveryScreen displays habit title, xp, and correct messaging',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            home: StreakRecoveryScreen(habit: habit, xpEarned: 50),
          ),
        ),
      );
  ...
  testWidgets('StreakRecoveryScreen pops on CONTINUE tap', (
    WidgetTester tester,
  ) async {
    final habit = Habit(
      id: 'h1',
