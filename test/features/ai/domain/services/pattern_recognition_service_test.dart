...
void main() {
  group('PatternRecognitionService', () {
    ...
    HabitCompletionsTableData makeCompletion(String id, String habitId, DateTime date) {
    ...
    test('analyzePatterns returns "No recent history" for empty list', () {
      final result = PatternRecognitionService.analyzePatterns([], referenceDate: now);
      expect(result['status'], 'No recent history');
    });

    test('analyzePatterns detects dropping off velocity', () {
      final completions = [
        makeCompletion('1', 'habit_a', DateTime(2025, 1, 5)), // 10 days ago (previous 7)
        makeCompletion('2', 'habit_a', DateTime(2025, 1, 6)), // 9 days ago (previous 7)
        makeCompletion('3', 'habit_a', DateTime(2025, 1, 14)), // 1 day ago (last 7)
      ];

      final result = PatternRecognitionService.analyzePatterns(completions, referenceDate: now);
    ...
    test('analyzePatterns detects accelerating velocity', () {
      final completions = [
        makeCompletion('1', 'habit_b', DateTime(2025, 1, 5)), // 10 days ago (previous 7)
        makeCompletion('2', 'habit_b', DateTime(2025, 1, 13)), // 2 days ago (last 7)
        makeCompletion('3', 'habit_b', DateTime(2025, 1, 14)), // 1 day ago (last 7)
      ];
    ...
    test('analyzePatterns detects steady velocity', () {
      final completions = [
        makeCompletion('1', 'habit_c', DateTime(2025, 1, 5)), // 10 days ago (previous 7)
        makeCompletion('2', 'habit_c', DateTime(2025, 1, 14)), // 1 day ago (last 7)
      ];
