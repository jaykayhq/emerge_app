...
void main() {
  group('habitCardFillFraction', () {
    ...
    test('totalSeconds>0 and remainingSeconds=totalSeconds returns 0', () {
      expect(
        habitCardFillFraction(remainingSeconds: 120, totalSeconds: 120),
        0.0,
      );
    });
    ...
    test('remainingSeconds=0 returns 1 (fully filled)', () {
      expect(
        habitCardFillFraction(remainingSeconds: 0, totalSeconds: 120),
        1.0,
      );
    });
    ...
    test('halfway returns ~0.5', () {
      expect(
        habitCardFillFraction(remainingSeconds: 60, totalSeconds: 120),
        closeTo(0.5, 1e-9),
      );
    });
    ...
    test('remainingSeconds > totalSeconds clamps to 0 (defensive)', () {
      expect(
        habitCardFillFraction(remainingSeconds: 200, totalSeconds: 120),
        0.0,
      );
    });
    ...
    test('negative remainingSeconds clamps to 1 (defensive)', () {
      expect(
        habitCardFillFraction(remainingSeconds: -5, totalSeconds: 120),
        1.0,
      );
    });
