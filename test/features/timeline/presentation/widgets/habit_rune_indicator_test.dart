...
void main() {
  ...
  testWidgets(
    'HabitRuneIndicator renders custom painter when unconfigured (dormant)',
    (tester) async {
  ...
  testWidgets('HabitRuneIndicator renders container when configured (forged)', (
    tester,
  ) async {
  ...
  testWidgets('HabitRuneIndicator pulses opacity over time when dormant', (
    tester,
  ) async {
    final habit = makeHabit();
    await tester.pumpWidget(
