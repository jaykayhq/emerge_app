...
void main() {
  ...
  test('attributeCompletions handles null user gracefully', () async {
    ...
    final subscription = container.listen(
      attributeCompletionsProvider('vitality'),
      (_, _) {},
    );

    final result = await container.read(
      attributeCompletionsProvider('vitality').future,
    );
  ...
  test(
    'attributeCompletions accumulates XP into correct day buckets',
    () async {
      ...
      when(
        () => mockRepository.getCompletionsBetweenDates(any(), any(), any()),
