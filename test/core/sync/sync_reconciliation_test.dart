...
void main() {
  ...
  setUp(() {
    ...
    when(
      () => mockFirestore.collection('user_activity'),
  ...
  group('SyncEngine at-least-once reconciliation', () {
    MutationQueueTableData pendingSet() => MutationQueueTableData(
      ...
      documentId: 'act_1',
      operation: 'set',
      dataJson: '{"userId":"u1","type":"habit_completion","date":"2026-08-13"}',
    ...
    test(
      'drops a set mutation denied on an EXISTING doc (already applied)',
      () async {
    ...
    test(
      'keeps retrying a set mutation denied when the doc does NOT exist',
      () async {
